...
```
### Halo Bitcoin
Jalankan php app.php di direktori proyek.
```bash
php app.php
```
```bash
...
```
Bot terhubung ke mixin.one berhasil ketika konsol menampilkan "LIST_PENDING_MESSAGES".
![pay-links](https://github.com/wenewzhang/mixin_labs-php-bot/raw/master/pay-links.jpg)


Bot telah memberi tahu Anda cara berinteraksi:
- **1** bot mengirim tautan APP_CARD.
- **2** bot mengirim tautan APP_BUTTON_GROUP.
- **?** atau untuk bantuan ! anda dapat
Klik tautan di halaman obrolan, masukkan kode PIN untuk membayar koin ke bot.
...
Kode lengkap ada [disini](https://github.com/wenewzhang/mixin_labs-php-bot/blob/master/app.php)
